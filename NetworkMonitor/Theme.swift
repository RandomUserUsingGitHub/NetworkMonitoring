...
struct AppTheme {
    ...
    static let green = AppTheme(
        name: "green",
        bg: .hex("#0d1117"), bg2: .hex("#161b22"),
        border: .hex("#30a14e"), accent: .hex("#3fb950"), accent2: .hex("#56d364"),
        text: .hex("#e6edf3"), dim: .hex("#8b949e"),
    ...
    static let amber = AppTheme(
        name: "amber",
        bg: .hex("#13100a"), bg2: .hex("#1e1810"),
        border: .hex("#d4820a"), accent: .hex("#e8920a"), accent2: .hex("#f5a623"),
        text: .hex("#f0e6d3"), dim: .hex("#9e8060"),
    ...
    static let blue = AppTheme(
        name: "blue",
        bg: .hex("#0d1117"), bg2: .hex("#0d1f2d"),
        border: .hex("#1f6feb"), accent: .hex("#388bfd"), accent2: .hex("#79c0ff"),
        text: .hex("#e6edf3"), dim: .hex("#8b949e"),
    ...
    static let red = AppTheme(
        name: "red",
        bg: .hex("#130d0d"), bg2: .hex("#1e1010"),
        border: .hex("#b91c1c"), accent: .hex("#ef4444"), accent2: .hex("#f87171"),
        text: .hex("#f0e6e6"), dim: .hex("#9e7070"),
